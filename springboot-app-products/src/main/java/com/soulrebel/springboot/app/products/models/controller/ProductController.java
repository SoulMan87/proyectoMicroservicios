...
public class ProductController {
    ...
    public List<Product> listProducts() {
        return productService.findAllServ( ).stream( ).peek(product -> product.setPort(Integer.parseInt(Objects.requireNonNull(env.getProperty("local.server.port"))))).collect(Collectors.toList( ));
    }
